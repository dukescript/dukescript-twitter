...
/**
 * This is an implementation package - just include its JAR on classpath and use
 * official {@link Context} API to access the functionality.
 * <p>
 *
 * @author Jaroslav Tulach modified by Anton Epple <anton.epple@eppleton.de>
 */
@Contexts.Id("xhr")
final class AuthorizedTransfer
        implements Transfer {
